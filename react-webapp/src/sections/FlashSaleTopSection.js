...
var p = { id: 1, name: "Modern Brown Blouse", category: "Fashion", price: "$35.00", rating: 5, img: "https://images.pexels.com/photos/9604177/pexels-photo-9604177.jpeg?auto=compress&cs=tinysrgb&w=1600" }
var p2 = [
  ...
  return (
    <section className="flash-top">
      ...
      <div className="flash-top-product">
        <div className="flash-product"><SmallProductGridSection products={p2} /></div>
      </div>
    </section>
  )
}
